...
public final class AntipodalEndPointsException extends GeometryException {
    ...
    AntipodalEndPointsException(final PositionVector v1, final PositionVector v2) {
        super(msg(v1, v2));
    }
